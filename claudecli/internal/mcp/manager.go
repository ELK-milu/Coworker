...
import (
	...
	"github.com/QuantumNous/new-api/claudecli/internal/mcp/transport"
)
...
func (m *Manager) initialize(ctx context.Context, conn *Connection) error {
	...
	initMsg := &transport.Message{
		...
		ID:      1,
		Method:  "initialize",
		Params:  json.RawMessage(`{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"claudecli","version":"1.0.0"}}`),
	}
